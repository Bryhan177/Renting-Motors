...
begin
  ...
  insert into pg_temp.excel_pagos (
    ...
    ('RIP44G', 'diego', '2026-03-03'::date, 'N/A', 0, 50102, 'POLIZA DE SEGURO (3 marzo)', 'PSE', '[excel-import-20260908] · Excel RIP44G · Se pago el últimó día, no genero mora'),
    ...
    ('FSS51B', 'wbeimar', '2026-04-06'::date, 'N/A', 0, 64000, 'TRAMITE TRASPASOS', 'TRANSFERENCIA', '[excel-import-20260908] · Excel FSS51B · Tramite extra en traspasos'),
    ('RIP44G', 'diego', '2026-04-03'::date, 'N/A', 0, 50102, 'POLIZA DE SEGURO (3 abril)', 'PSE', '[excel-import-20260908] · Excel RIP44G · Se pago el últimó día, no genero mora'),
    ...
    ('RIP44G', 'diego', '2026-05-03'::date, 'N/A', 0, 50102, 'POLIZA DE SEGURO (3 de mayo)', 'PSE', '[excel-import-20260908] · Excel RIP44G · Se pago el último día, no genero mora'),
  ...
  select
    ...
    e.metodo_pago,
    e.observaciones,
    coalesce(nullif(trim(e.semana), ''), 'N/A'),
    true,
    v_actor,
    null,
    'registrado',
